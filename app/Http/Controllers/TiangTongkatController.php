...
use App\Models\TiangTongkat;
use App\Models\Inventaris;
use Illuminate\Http\Request;

class TiangTongkatController extends Controller
{
     ...
     *
     * @param  \App\Models\TiangTongkat  $tiangTongkat
     * @return \Illuminate\Http\Response
     */
    public function show(TiangTongkat $tiangTongkat)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(TiangTongkat $tiangTongkat)
    {
        $terminalkabel = TerminalKabel::findOrFail($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, TiangTongkat $tiangTongkat)
    {
        $validated = $request->validate([
            'kode' => 'required|unique:terminalkabel',
            'namaBarang' => 'required',
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(TiangTongkat $tiangTongkat)
    {
        $terminalkabel = TerminalKabel::findOrFail($id);
